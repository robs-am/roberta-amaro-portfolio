...
- [ ] 6.3 Aplicar `data-reveal` aos títulos de seção, itens da timeline e cards, e a animação CSS de carregamento ao hero (nome, título e bio em sequência, 400ms); verificar que timeline e cards entram em sequência ao rolar, que um card entrando sozinho não espera atraso, e que, ao trocar de idioma com os projetos na tela, os cards não ficam ocultos
